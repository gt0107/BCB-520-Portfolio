...
# Assuming 'Institution' is the column containing institution names
# and 'Award_Money' is the column containing the award money
# 'USDA_Compare_Data' is the data frame containing the USDA grant data
